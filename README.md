...
秉承“Better Experience更优体验”的原则，Bettbox在继承原版优秀界面的基础上，深度优化了诸多细节功能与实用配置，致力于成为体验更好的 Mihomo 客户端

<p align="center">
  <img src="snapshots/readme.jpg" alt="Snapshots" width="810">
</p>
...
* **社区包容性**：我们倾听社区用户的想法并且会认真评估，你的声音不会无故被淹没和被无视(认真的ISSUE值得被认真对待)
...
* [Mihomo](https://github.com/MetaCubeX/mihomo) - 强大灵活好用的代理内核
